...
import { featured, getGenreList } from '../../redux/movie-store/actions';
...
const CarouselTwo = () => {
    ...
    const randomIndex = Math.floor(Math.random() * (20 - 5));

    const trendingMovies = trendingMovie.slice(randomIndex, randomIndex + 5);
    ...
    const prevSlide = () => {
        setCurrentSlide(prev => (prev === 0 ? trendingMovies.length - 1 : prev - 1));
    };
                                            ...
                                            <div className='absolute mb-11 inset-x-0 bottom-0 lg:bottom-30 xl:bottom-40 left-10 z-30 '>
                                                ...
                                                <div className="max-sm:flex max-sm:justify-center max-sm:flex-wrap ">
                                                    <div className="meta flex mt-3 items-center max-sm:text-center">
                                                        ...
                                                        <span className='text-white mr-3 max-sm:font-medium max-sm:text-xs max-sm:text-zinc-50 max-sm:items-center '>{parseFloat(movie.vote_average.toString().slice(0, -2))}</span>
                                                        ...
                                                        {/* <span className={`genres text-zinc-400 text-sm ml-2 font-semibold max-sm:font-medium max-sm:text-xs max-sm:pl-3 max-sm:block max-sm:w-max  ${genre != "" ? 'px-2 rounded-md' : ''} max-sm:block`}>
                                                            {genre}
                                                        </span> */}
 {
